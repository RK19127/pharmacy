                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="label label-danger">
                                        @if($user->roles_id == '1') @lang('users.superadmin')
                                        @elseif($user->roles_id == '2') Manager
                                        @elseif($user->roles_id == '3') Cashier
                                        @elseif($user->roles_id == '4') Pharmacist
                                        @else @lang('users.admin') @endif 
                                    </span>
                                </td>
